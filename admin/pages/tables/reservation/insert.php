                ...
                <form method=post>
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="code reservation" name="kode_reserv">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="desc" name="reserv_at">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="desc" name="kd_tempat">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="desc" name="depart_at">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-1">
                      <div class="form-group">
                        <label>Price</label>
                        <input type="text" class="form-control" placeholder="desc" name="price">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-11 pr-1">
                      <div class="form-group">
                        ...
                        <select name="user" id="" class="form-control">
                          ...
                          {
                          ?>
                            <option value="<?php echo $data_usr['id_user']; ?>"><?php echo $data_usr['fullname']; ?></option>
                          <?php
                          }
                          ?>
                        </select>
...
if(isset($_POST['yes']))
{
        ...
        $run = $run_crud->insert('reservation', $add);
        if($run == "ok")
        {
